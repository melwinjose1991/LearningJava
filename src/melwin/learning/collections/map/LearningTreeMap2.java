...
public class LearningTreeMap2 {
	...
	public static void main(String[] args) {
		...
		if (s.put(new Student(1), 1) == null)
			System.out.println("\tadding (new Student(1),1) SUCCESS");
		else
			System.out.println("\tadding (new Student(1),1) FAIL");
		...
		if (s.put(new Student(2), 2) == null)
			System.out.println("\tadding (new Student(2), 2) SUCCESS");
		else
			System.out.println("\tadding (new Student(2), 2) FAIL !!!");

		Student three = new Student(3);
		System.out.println("\nGoing to add (three, 3)");
		if (s.put(three, 3) == null)
			System.out.println("\tadding (three, 3) SUCCESS");
		else
			System.out.println("\tadding (three, 3) FAIL !!!");
		...
		if (s.put(three, 4) == null)
			System.out.println("\tadding add(three,4) SUCCESS");
		else
			System.out.println("\tadding add(three,4) FAIL !!!");

		System.out.println("\nSearching three");
		if (s.containsKey(three))
