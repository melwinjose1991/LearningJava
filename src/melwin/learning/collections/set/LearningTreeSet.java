...
public class LearningTreeSet {
	...
	public static void main(String[] args) {
		...
		if (s.add(new Student(1)))
			System.out.println("\tadding new Student(1) SUCCESS");
		else
			System.out.println("\tadding new Student(1) FAIL");
		...
		if (s.add(new Student(2)))
			System.out.println("\tadding new Student(2) SUCCESS");
		else
			System.out.println("\tadding new Student(2) FAIL !!!");

		Student three = new Student(3);
		System.out.println("\nGoing to add three");
		if (s.add(three))
			System.out.println("\tadding three SUCCESS");
		else
			System.out.println("\tadding three FAIL !!!");
