...
public class LearningTreeMap {
	...
	public static void main(String[] args) {
		...
		if(s.put(1,new Student(1)) == null) System.out.println("\tadding (1,new Student(1)) SUCCESS");
		else System.out.println("\tadding (1, new Student(1)) FAIL");
		...
		if(s.put(2, new Student(2)) == null) System.out.println("\tadding (2, new Student(2)) SUCCESS");
		else System.out.println("\tadding (2, new Student(2)) FAIL !!!");
		
		
		Student three = new Student(3);
		System.out.println("\nGoing to add (3, three)");
		if(s.put(3,three) == null) System.out.println("\tadding add(3, three) SUCCESS");
		else System.out.println("\tadding add(3, three) FAIL !!!");
		...
		if(s.put(4,three) == null) System.out.println("\tadding add(4, three) SUCCESS");
		else System.out.println("\tadding add(4, three) FAIL !!!");
		
		
		System.out.println("\nSearching three");
		if(s.containsKey(3)) System.out.println("\tthree FOUND");
